...
proc sql;
select distinct ScoreValue_41 from equifax2.equifax102013;
run;

/*11787287 observations total*/
proc sql;
create table soco_sou.equifax102014_score as
select equi2013.* ,equi2014.ScoreValue_41 as ScoreValue_41_2014
from equifax2.equifax102013  as equi2013,
equifax2.equifax102014  as equi2014
where equi2013.MPID=equi2014.MPID;
run;

proc sql;
select distinct ScoreValue_41_2014 from SOCO_SOU.equifax102014_score;
run;
/*4772535 observations after removing missing values in target variable*/ 
data SOCO_SOU.equifax102014_score ;
set SOCO_SOU.equifax102014_score (drop= ScoreValue_41) ;
where ScoreValue_41_2014 ne .;
run;
/*Removing credit score value Zero as it is invalid after remvoing 4693371 observations*/
data SOCO_SOU.equifax102014_score ;
set SOCO_SOU.equifax102014_score ;
...
proc univariate data=SOCO_SOU.equifax102014_score ;
...
proc freq data=SOCO_SOU.equifax102014_score  ;
tables BADCredit;
run;


proc means data=soco_sou.equifax102014_score  N NMISS min q1 median q3 max;
run;

/* removing posthoc variables now 279 variables after dropping them*/
data SOCO_SOU.equifax102014_score ;
set soco_sou.equifax102014_score (drop=CrdRiskScore1
SCR0041
ReasonCode1_41
ReasonCode2_41
ReasonCode3_41
...
data SOCO_SOU.equifax102014_scorenum;
set SOCO_SOU.equifax102014_score (keep=_NUMERIC_);
run;

/*11 character*/
data SOCO_SOU.equifax102014_scorechar;
set SOCO_SOU.equifax102014_score (keep=_CHAR_);
run;
...
proc contents data=SOCO_SOU.equifax102011_2014_GT450CHAR;
run;


proc contents data=SOCO_SOU.equifax102011_14_GT450num;
run;
%IMPV3(DSN=SOCO_SOU.equifax102014_scorenum, VARS=_ALL_, EXCLUDE = SnapshotDate ArchiveDate ScoreValue_41_2014 BADCREDIT,PCTREM=0.5,MSTD=4)/MINOPERATOR;

proc means data=SOCO_SOU.equifax102014_scorenumout nmiss min q1 median q3 max;
run;


proc contents data=SOCO_SOU.equifax102014_scorenumout;
run;

/**example of numeric variables before imputation: totNFPDAmt24mon**/
proc univariate data=SOCO_SOU.equifax102014_scorenum noprint;
var HstNFB24mon;
histogram;
run;
proc means data=SOCO_SOU.equifax102014_scorenum min max;
var totNFPDAmt24mon;
run;


/**example of numeric variables after imputation: totNFPDAmt24mon**/
proc univariate data=SOCO_SOU.equifax102014_scorenumout noprint;
var HstNFACmt3mon;
histogram;
run;
proc means data=SOCO_SOU.equifax102014_scorenumout min max;
run;
proc contents data=SOCO_SOU.equifax102014_scorenumout;
run;

proc contents data=SOCO_SOU.equifax102014_12monthdata;
run;

Data SOCO_SOU.equifax102014_12monthdata(drop=NoNFA24mon totNFA1CPD24mon
totNFA1CPDC24mon
HstNFB24mon
pctNFC4PDAmt24mon
TotUtiNFA24mon
...
set SOCO_SOU.equifax102014_scorenumout;
run;


Data SOCO_SOU.equifax102014_3monthdata(drop=NoNFA12mon pctSasNFA12mon
TotUtiNFA12mon
pctNFPDAmt12mon
pctNFChgAccAcc12mon
pctNFC4PDAmt12mon
);
set SOCO_SOU.equifax102014_12monthdata;
run;

Data SOCO_SOU.equifax102014_24monthdata;
set SOCO_SOU.equifax102014_scorenumout;
run;


%let ds2 = SOCO_SOU.equifax102014_12monthdata;
...
%let ds2 = SOCO_SOU.equifax102014_24monthdata;
...
%let ds2 = SOCO_SOU.equifax102014_3monthdata;
...
proc contents data=SOCO_SOU.equifax102014_scorechar;
run;
/*4693371 observations and 41 variables*/
data SOCO_SOU.equifax102014_Merge3M;
merge SOCO_SOU.equifax102014_3monthdata SOCO_SOU.equifax102014_scorechar;
run;
/*4693371 observations and 46 variables*/
data SOCO_SOU.equifax102014_Merge12M;
merge SOCO_SOU.equifax102014_12monthdata SOCO_SOU.equifax102014_scorechar;
run;
/*4693371 observations and 67 variables*/
data SOCO_SOU.equifax102014_Merge24M;
merge SOCO_SOU.equifax102014_24monthdata SOCO_SOU.equifax102014_scorechar;
run;

proc contents data=soco_sou.equifax102014_scorechar;
run;

proc contents data=soco_sou.equifax102014_24monthdata ;
run;
...
set SOCO_SOU.equifax102014_Merge3M(keep=&var _char_ BADCredit);
run;
...
set SOCO_SOU.equifax102014_Merge24M(keep=&var1 _char_ BADCredit);
run;


proc contents data=soco_sou.equifax102014_merge12m;
run;
...
set SOCO_SOU.equifax102014_Merge12M(keep=&var3 _char_ BADCredit);
run;
